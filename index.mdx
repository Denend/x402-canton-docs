...
Canton Coin, and retries — the payment itself is the credential. No API keys, no
billing accounts.
...
transaction — no escrow, no lock step, no facilitator custody.
...
<CardGroup cols={3}>
  ...
  <Card title="Merchant integration" icon="store" href="/x402-merchant">
    Charge Canton Coin per request on your Express or Next.js API.
  </Card>
</CardGroup>
